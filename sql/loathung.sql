...
Source Server         : Data-local
Source Server Version : 50621
Source Host           : localhost:3306
Source Database       : loathung

Target Server Type    : MYSQL
Target Server Version : 50621
File Encoding         : 65001

Date: 2015-11-28 17:40:20
*/
...
-- ----------------------------
INSERT INTO `oc_address` VALUES ('1', '1', 'phanha', 'phan', '', '123', '', '123', '', '230', '3776', '');
...
-- ----------------------------
-- Records of oc_article
-- ----------------------------

-- ----------------------------
-- Table structure for oc_article_description
-- ----------------------------
...
-- ----------------------------
-- Records of oc_article_description
-- ----------------------------

-- ----------------------------
-- Table structure for oc_article_related
-- ----------------------------
...
-- ----------------------------
-- Records of oc_article_related
-- ----------------------------

-- ----------------------------
-- Table structure for oc_article_to_layout
-- ----------------------------
...
-- ----------------------------
-- Records of oc_article_to_layout
-- ----------------------------

-- ----------------------------
-- Table structure for oc_article_to_store
-- ----------------------------
...
-- ----------------------------
-- Records of oc_article_to_store
-- ----------------------------
...
-- ----------------------------
INSERT INTO `oc_banner` VALUES ('6', 'Free shiping', '0');
...
-- ----------------------------
INSERT INTO `oc_banner_image` VALUES ('107', '7', 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'catalog/loa/loa.jpg', '0');
INSERT INTO `oc_banner_image` VALUES ('105', '6', 'index.php?route=product/manufacturer/info&amp;manufacturer_id=7', 'catalog/loa/loa.jpg', '0');
INSERT INTO `oc_banner_image` VALUES ('113', '8', '', 'catalog/loa/loa4.jpg', '0');
INSERT INTO `oc_banner_image` VALUES ('112', '8', '', 'catalog/loa/loa.jpg', '0');
INSERT INTO `oc_banner_image` VALUES ('106', '7', '', 'catalog/loa/loa2.jpg', '0');
INSERT INTO `oc_banner_image` VALUES ('111', '8', '', 'catalog/loa/loa4.jpg', '0');
INSERT INTO `oc_banner_image` VALUES ('110', '8', '', 'catalog/loa/loa2.jpg', '0');
INSERT INTO `oc_banner_image` VALUES ('108', '7', '', 'catalog/loa/loa4.jpg', '0');
INSERT INTO `oc_banner_image` VALUES ('109', '7', '', 'catalog/loa/loa3.jpg', '0');
...
-- ----------------------------
INSERT INTO `oc_banner_image_description` VALUES ('107', '1', '7', 'iPhone 6');
INSERT INTO `oc_banner_image_description` VALUES ('107', '2', '7', 'iPhone 6');
INSERT INTO `oc_banner_image_description` VALUES ('106', '1', '7', 'MacBookAir');
INSERT INTO `oc_banner_image_description` VALUES ('113', '1', '8', 'Starbucks');
INSERT INTO `oc_banner_image_description` VALUES ('113', '2', '8', 'Starbucks');
INSERT INTO `oc_banner_image_description` VALUES ('112', '1', '8', 'Sony');
INSERT INTO `oc_banner_image_description` VALUES ('106', '2', '7', 'MacBookAir');
INSERT INTO `oc_banner_image_description` VALUES ('112', '2', '8', 'Sony');
INSERT INTO `oc_banner_image_description` VALUES ('111', '1', '8', 'RedBull');
INSERT INTO `oc_banner_image_description` VALUES ('111', '2', '8', 'RedBull');
INSERT INTO `oc_banner_image_description` VALUES ('110', '1', '8', 'NFL');
INSERT INTO `oc_banner_image_description` VALUES ('110', '2', '8', 'NFL');
INSERT INTO `oc_banner_image_description` VALUES ('105', '1', '6', 'Free Shipping');
INSERT INTO `oc_banner_image_description` VALUES ('105', '2', '6', 'Miễn phí giao hàng');
INSERT INTO `oc_banner_image_description` VALUES ('108', '2', '7', 'loa 2');
INSERT INTO `oc_banner_image_description` VALUES ('108', '1', '7', 'loa 2');
INSERT INTO `oc_banner_image_description` VALUES ('109', '2', '7', 'loa 3');
INSERT INTO `oc_banner_image_description` VALUES ('109', '1', '7', 'loa 3');
...
-- Records of oc_cart
-- ----------------------------
INSERT INTO `oc_cart` VALUES ('5', '0', 'nht70pd135r48ejkf19dp7sf42', '40', '0', '[]', '2', '2015-11-28 16:56:13');
INSERT INTO `oc_cart` VALUES ('6', '0', 'nht70pd135r48ejkf19dp7sf42', '41', '0', '[]', '1', '2015-11-28 16:56:16');
INSERT INTO `oc_cart` VALUES ('7', '0', 'nht70pd135r48ejkf19dp7sf42', '36', '0', '[]', '1', '2015-11-28 16:57:08');
...
-- ----------------------------
INSERT INTO `oc_currency` VALUES ('1', 'Pound Sterling', 'GBP', '£', '', '2', '0.66530001', '1', '2015-11-28 03:46:21');
INSERT INTO `oc_currency` VALUES ('2', 'US Dollar', 'USD', '$', '', '2', '1.00000000', '1', '2015-11-28 11:11:07');
INSERT INTO `oc_currency` VALUES ('3', 'Euro', 'EUR', '', '€', '2', '0.94410002', '1', '2015-11-28 03:46:21');
...
-- ----------------------------
INSERT INTO `oc_customer` VALUES ('1', '1', '0', 'phanha', 'phan', 'phanthanhhak55hus@gmail.com', '123123', '123123', 'a784433dab628af71724e0889e974d3bc9a974de', 'vgcf76Shu', null, null, '1', '1', '', '127.0.0.1', '1', '1', '0', '', '2015-11-28 17:01:28');
...
-- ----------------------------
INSERT INTO `oc_customer_activity` VALUES ('1', '1', 'register', '{\"customer_id\":1,\"name\":\"phanha phan\"}', '127.0.0.1', '2015-11-28 17:01:29');
...
-- ----------------------------
INSERT INTO `oc_customer_ip` VALUES ('1', '1', '127.0.0.1', '2015-11-28 17:01:29');
...
INSERT INTO `oc_extension` VALUES ('27', 'module', 'article');
...
INSERT INTO `oc_layout` VALUES ('16', 'Article');
...
INSERT INTO `oc_layout_module` VALUES ('103', '1', 'category', 'column_left', '1');
...
INSERT INTO `oc_layout_module` VALUES ('102', '1', 'featured.28', 'content_bottom', '2');
INSERT INTO `oc_layout_module` VALUES ('101', '1', 'latest.32', 'content_bottom', '1');
INSERT INTO `oc_layout_module` VALUES ('104', '1', 'slideshow.27', 'content_top', '1');
...
INSERT INTO `oc_layout_route` VALUES ('65', '16', '0', 'article/');
...
INSERT INTO `oc_module` VALUES ('31', 'Free shiping', 'banner', '{\"name\":\"Free shiping\",\"banner_id\":\"6\",\"width\":\"182\",\"height\":\"182\",\"status\":\"1\"}');
...
-- ----------------------------
INSERT INTO `oc_product` VALUES ('28', 'Product 1', '', '', '', '', '', '', '', '939', '7', 'catalog/loa/loa.jpg', '5', '1', '100.0000', '200', '9', '2009-02-03', '146.40000000', '2', '0.00000000', '0.00000000', '0.00000000', '1', '1', '1', '0', '1', '0', '2009-02-03 16:06:50', '2015-11-28 17:16:00');
...
INSERT INTO `oc_product` VALUES ('30', 'Product 3', '', '', '', '', '', '', '', '7', '6', 'catalog/loa/loa2.jpg', '9', '1', '100.0000', '0', '9', '2009-02-03', '0.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '1', '1', '1', '0', '1', '0', '2009-02-03 16:59:00', '2015-11-28 17:15:41');
...
INSERT INTO `oc_product` VALUES ('32', 'Product 5', '', '', '', '', '', '', '', '999', '6', 'catalog/loa/M3300sfs.jpg', '8', '1', '100.0000', '0', '9', '2009-02-03', '5.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '1', '1', '1', '0', '1', '0', '2009-02-03 17:07:26', '2015-11-28 17:21:01');
...
INSERT INTO `oc_product` VALUES ('34', 'Product 7', '', '', '', '', '', '', '', '1000', '6', 'catalog/loa/8633_loa-may-tinh-edifier-c521.jpg', '8', '1', '100.0000', '0', '9', '2009-02-03', '5.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '2', '1', '1', '0', '1', '0', '2009-02-03 18:07:54', '2015-11-28 17:20:46');
INSERT INTO `oc_product` VALUES ('35', 'Product 8', '', '', '', '', '', '', '', '1000', '5', 'catalog/loa/M3100SFb.jpg', '0', '0', '100.0000', '0', '9', '2009-02-03', '5.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '1', '1', '1', '0', '1', '0', '2009-02-03 18:08:31', '2015-11-28 17:22:19');
INSERT INTO `oc_product` VALUES ('36', 'Product 9', '', '', '', '', '', '', '', '994', '6', 'catalog/loa/M3100SFb.jpg', '8', '0', '100.0000', '100', '9', '2009-02-03', '5.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '2', '1', '1', '0', '1', '1', '2009-02-03 18:09:19', '2015-11-28 17:20:27');
INSERT INTO `oc_product` VALUES ('40', 'product 11', '', '', '', '', '', '', '', '970', '5', 'catalog/loa/loa.jpg', '8', '1', '101.0000', '0', '9', '2009-02-03', '10.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '1', '1', '1', '0', '1', '3', '2009-02-03 21:07:12', '2015-11-28 17:16:38');
INSERT INTO `oc_product` VALUES ('41', 'Product 14', '', '', '', '', '', '', '', '977', '5', 'catalog/loa/loa2.jpg', '8', '1', '100.0000', '0', '9', '2009-02-03', '5.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '1', '1', '1', '0', '1', '0', '2009-02-03 21:07:26', '2015-11-28 17:16:18');
INSERT INTO `oc_product` VALUES ('42', 'Product 15', '', '', '', '', '', '', '', '990', '5', 'catalog/loa/loa3.jpg', '8', '1', '100.0000', '400', '9', '2009-02-04', '12.50000000', '1', '1.00000000', '2.00000000', '3.00000000', '1', '1', '2', '0', '1', '1', '2009-02-03 21:07:37', '2015-11-28 17:14:54');
INSERT INTO `oc_product` VALUES ('43', 'Product 16', '', '', '', '', '', '', '', '929', '5', 'catalog/loa/loa.jpg', '8', '0', '500.0000', '0', '9', '2009-02-03', '0.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '2', '1', '1', '0', '1', '0', '2009-02-03 21:07:49', '2015-11-28 17:21:27');
INSERT INTO `oc_product` VALUES ('44', 'Product 17', '', '', '', '', '', '', '', '1000', '5', 'catalog/loa/M3300sfs.jpg', '8', '1', '1000.0000', '0', '9', '2009-02-03', '0.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '2', '1', '1', '0', '1', '0', '2009-02-03 21:08:00', '2015-11-28 17:22:04');
...
INSERT INTO `oc_product` VALUES ('47', 'Product 21', '', '', '', '', '', '', '', '1000', '5', 'catalog/loa/loa4.jpg', '7', '1', '100.0000', '400', '9', '2009-02-03', '1.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '1', '0', '1', '0', '1', '0', '2009-02-03 21:08:40', '2015-11-28 17:15:26');
INSERT INTO `oc_product` VALUES ('48', 'product 20', 'test 1', '', '', '', '', '', 'test 2', '995', '5', 'catalog/loa/32476_loa-may-tinh-edifier-hcs2330-21.jpg', '8', '1', '100.0000', '0', '9', '2009-02-08', '1.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '2', '1', '1', '0', '1', '0', '2009-02-08 17:21:51', '2015-11-28 17:19:57');
INSERT INTO `oc_product` VALUES ('49', 'SAM1', '', '', '', '', '', '', '', '0', '8', 'catalog/demo/samsung_tab_1.jpg', '0', '1', '199.9900', '0', '9', '2011-04-25', '0.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '1', '1', '1', '1', '1', '4', '2011-04-26 08:57:34', '2011-09-30 01:06:23');
...
-- ----------------------------
INSERT INTO `oc_product_description` VALUES ('48', '1', 'Thùng loa Community', '&lt;div class=&quot;cpt_product_description &quot;&gt;\r\n	&lt;div&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;More room to move.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			With 80GB or 160GB of storage and up to 40 hours of battery life, the new iPod classic lets you enjoy up to 40,000 songs or up to 200 hours of video or any combination wherever you go.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Cover Flow.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Browse through your music collection by flipping through album art. Select an album to turn it over and see the track list.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Enhanced interface.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Experience a whole new way to browse and view your music and video.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Sleeker design.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Beautiful, durable, and sleeker than ever, iPod classic now features an anodized aluminum and polished stainless steel enclosure with rounded edges.&lt;/p&gt;\r\n	&lt;/div&gt;\r\n&lt;/div&gt;\r\n&lt;!-- cpt_container_end --&gt;', '', 'Thùng loa Community', '', '');
INSERT INTO `oc_product_description` VALUES ('40', '1', 'Thùng loa Community', '&lt;p class=&quot;intro&quot;&gt;\r\n	iPhone is a revolutionary new mobile phone that allows you to make a call by simply tapping a name or number in your address book, a favorites list, or a call log. It also automatically syncs all your contacts from a PC, Mac, or Internet service. And it lets you select and listen to voicemail messages in whatever order you want just like email.&lt;/p&gt;\r\n', '', 'Thùng loa Community', '', '');
...
INSERT INTO `oc_product_description` VALUES ('47', '1', 'Thùng loa Community', '&lt;p&gt;\r\n	Stop your co-workers in their tracks with the stunning new 30-inch diagonal HP LP3065 Flat Panel Monitor. This flagship monitor features best-in-class performance and presentation features on a huge wide-aspect screen while letting you work as comfortably as possible - you might even forget you\'re at the office&lt;/p&gt;\r\n', '', 'Thùng loa Community', '', '');
...
INSERT INTO `oc_product_description` VALUES ('30', '1', 'Thùng loa Community', '&lt;p&gt;\r\n	Canon\'s press material for the EOS 5D states that it \'defines (a) new D-SLR category\', while we\'re not typically too concerned with marketing talk this particular statement is clearly pretty accurate. The EOS 5D is unlike any previous digital SLR in that it combines a full-frame (35 mm sized) high resolution sensor (12.8 megapixels) with a relatively compact body (slightly larger than the EOS 20D, although in your hand it feels noticeably \'chunkier\'). The EOS 5D is aimed to slot in between the EOS 20D and the EOS-1D professional digital SLR\'s, an important difference when compared to the latter is that the EOS 5D doesn\'t have any environmental seals. While Canon don\'t specifically refer to the EOS 5D as a \'professional\' digital SLR it will have obvious appeal to professionals who want a high quality digital SLR in a body lighter than the EOS-1D. It will also no doubt appeal to current EOS 20D owners (although lets hope they\'ve not bought too many EF-S lenses...) äë&lt;/p&gt;\r\n', '', 'Thùng loa Community', '', '');
INSERT INTO `oc_product_description` VALUES ('35', '2', ' Và F 215', '&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n', '', ' Và F 215', '', '');
INSERT INTO `oc_product_description` VALUES ('48', '2', 'Thùng loa Community', '&lt;div class=&quot;cpt_product_description &quot;&gt;\r\n	&lt;div&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;More room to move.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			With 80GB or 160GB of storage and up to 40 hours of battery life, the new iPod classic lets you enjoy up to 40,000 songs or up to 200 hours of video or any combination wherever you go.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Cover Flow.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Browse through your music collection by flipping through album art. Select an album to turn it over and see the track list.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Enhanced interface.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Experience a whole new way to browse and view your music and video.&lt;/p&gt;\r\n		&lt;p&gt;\r\n			&lt;strong&gt;Sleeker design.&lt;/strong&gt;&lt;/p&gt;\r\n		&lt;p&gt;\r\n			Beautiful, durable, and sleeker than ever, iPod classic now features an anodized aluminum and polished stainless steel enclosure with rounded edges.&lt;/p&gt;\r\n	&lt;/div&gt;\r\n&lt;/div&gt;\r\n&lt;!-- cpt_container_end --&gt;', '', 'Thùng loa Community', '', '');
INSERT INTO `oc_product_description` VALUES ('40', '2', 'Thùng loa Community', '&lt;p class=&quot;intro&quot;&gt;\r\n	iPhone is a revolutionary new mobile phone that allows you to make a call by simply tapping a name or number in your address book, a favorites list, or a call log. It also automatically syncs all your contacts from a PC, Mac, or Internet service. And it lets you select and listen to voicemail messages in whatever order you want just like email.&lt;/p&gt;\r\n', '', 'Thùng loa Community', '', '');
INSERT INTO `oc_product_description` VALUES ('28', '2', 'Thùng loa Community', '&lt;p&gt;\r\n	HTC Touch - in High Definition. Watch music videos and streaming content in awe-inspiring high definition clarity for a mobile experience you never thought possible. Seductively sleek, the HTC Touch HD provides the next generation of mobile functionality, all at a simple touch. Fully integrated with Windows Mobile Professional 6.1, ultrafast 3.5G, GPS, 5MP camera, plus lots more - all delivered on a breathtakingly crisp 3.8&quot; WVGA touchscreen - you can take control of your mobile world with the HTC Touch HD.&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Features&lt;/strong&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n	&lt;li&gt;\r\n		Processor Qualcomm® MSM 7201A™ 528 MHz&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Windows Mobile® 6.1 Professional Operating System&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Memory: 512 MB ROM, 288 MB RAM&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Dimensions: 115 mm x 62.8 mm x 12 mm / 146.4 grams&lt;/li&gt;\r\n	&lt;li&gt;\r\n		3.8-inch TFT-LCD flat touch-sensitive screen with 480 x 800 WVGA resolution&lt;/li&gt;\r\n	&lt;li&gt;\r\n		HSDPA/WCDMA: Europe/Asia: 900/2100 MHz; Up to 2 Mbps up-link and 7.2 Mbps down-link speeds&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Quad-band GSM/GPRS/EDGE: Europe/Asia: 850/900/1800/1900 MHz (Band frequency, HSUPA availability, and data speed are operator dependent.)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Device Control via HTC TouchFLO™ 3D &amp;amp; Touch-sensitive front panel buttons&lt;/li&gt;\r\n	&lt;li&gt;\r\n		GPS and A-GPS ready&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Bluetooth® 2.0 with Enhanced Data Rate and A2DP for wireless stereo headsets&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Wi-Fi®: IEEE 802.11 b/g&lt;/li&gt;\r\n	&lt;li&gt;\r\n		HTC ExtUSB™ (11-pin mini-USB 2.0)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		5 megapixel color camera with auto focus&lt;/li&gt;\r\n	&lt;li&gt;\r\n		VGA CMOS color camera&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Built-in 3.5 mm audio jack, microphone, speaker, and FM radio&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Ring tone formats: AAC, AAC+, eAAC+, AMR-NB, AMR-WB, QCP, MP3, WMA, WAV&lt;/li&gt;\r\n	&lt;li&gt;\r\n		40 polyphonic and standard MIDI format 0 and 1 (SMF)/SP MIDI&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Rechargeable Lithium-ion or Lithium-ion polymer 1350 mAh battery&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Expansion Slot: microSD™ memory card (SD 2.0 compatible)&lt;/li&gt;\r\n	&lt;li&gt;\r\n		AC Adapter Voltage range/frequency: 100 ~ 240V AC, 50/60 Hz DC output: 5V and 1A&lt;/li&gt;\r\n	&lt;li&gt;\r\n		Special Features: FM Radio, G-Sensor&lt;/li&gt;\r\n&lt;/ul&gt;\r\n', '', 'Thùng loa Community', '', '');
INSERT INTO `oc_product_description` VALUES ('44', '2', ' Và F 215', '&lt;div&gt;\r\n	MacBook Air is ultrathin, ultraportable, and ultra unlike anything else. But you don’t lose inches and pounds overnight. It’s the result of rethinking conventions. Of multiple wireless innovations. And of breakthrough design. With MacBook Air, mobile computing suddenly has a new standard.&lt;/div&gt;\r\n', '', ' Và F 215', '', '');
...
INSERT INTO `oc_product_description` VALUES ('36', '2', 'Thung sup ', '&lt;div&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Video in your pocket.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Its the small iPod with one very big idea: video. The worlds most popular music player now lets you enjoy movies, TV shows, and more on a two-inch display thats 65% brighter than before.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Cover Flow.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Browse through your music collection by flipping through album art. Select an album to turn it over and see the track list.&lt;strong&gt;&amp;nbsp;&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Enhanced interface.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Experience a whole new way to browse and view your music and video.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Sleek and colorful.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		With an anodized aluminum and polished stainless steel enclosure and a choice of five colors, iPod nano is dressed to impress.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;iTunes.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Available as a free download, iTunes makes it easy to browse and buy millions of songs, movies, TV shows, audiobooks, and games and download free podcasts all at the iTunes Store. And you can import your own music, manage your whole media library, and sync your iPod or iPhone with ease.&lt;/p&gt;\r\n&lt;/div&gt;\r\n', '', 'Thung sup ', '', '');
INSERT INTO `oc_product_description` VALUES ('46', '2', 'Sony VAIO', '&lt;div&gt;\r\n	Unprecedented power. The next generation of processing technology has arrived. Built into the newest VAIO notebooks lies Intel&amp;#39;s latest, most powerful innovation yet: Intel&amp;reg; Centrino&amp;reg; 2 processor technology. Boasting incredible speed, expanded wireless connectivity, enhanced multimedia support and greater energy efficiency, all the high-performance essentials are seamlessly combined into a single chip.&lt;/div&gt;\r\n', '', '', '', '');
INSERT INTO `oc_product_description` VALUES ('47', '2', 'Thùng loa Community', '&lt;p&gt;\r\n	Stop your co-workers in their tracks with the stunning new 30-inch diagonal HP LP3065 Flat Panel Monitor. This flagship monitor features best-in-class performance and presentation features on a huge wide-aspect screen while letting you work as comfortably as possible - you might even forget you\'re at the office&lt;/p&gt;\r\n', '', 'Thùng loa Community', '', '');
INSERT INTO `oc_product_description` VALUES ('32', '2', 'Thung sup ', '&lt;p&gt;\r\n	&lt;strong&gt;Revolutionary multi-touch interface.&lt;/strong&gt;&lt;br&gt;\r\n	iPod touch features the same multi-touch screen technology as iPhone. Pinch to zoom in on a photo. Scroll through your songs and videos with a flick. Flip through your library by album artwork with Cover Flow.&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Gorgeous 3.5-inch widescreen display.&lt;/strong&gt;&lt;br&gt;\r\n	Watch your movies, TV shows, and photos come alive with bright, vivid color on the 320-by-480-pixel display.&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Music downloads straight from iTunes.&lt;/strong&gt;&lt;br&gt;\r\n	Shop the iTunes Wi-Fi Music Store from anywhere with Wi-Fi.1 Browse or search to find the music youre looking for, preview it, and buy it with just a tap.&lt;/p&gt;\r\n&lt;p&gt;\r\n	&lt;strong&gt;Surf the web with Wi-Fi.&lt;/strong&gt;&lt;br&gt;\r\n	Browse the web using Safari and watch YouTube videos on the first iPod with Wi-Fi built in&lt;br&gt;\r\n	&amp;nbsp;&lt;/p&gt;\r\n', '', 'Thung sup ', '', '');
INSERT INTO `oc_product_description` VALUES ('41', '2', 'Thùng loa Community', '&lt;div&gt;\r\n	Just when you thought iMac had everything, now there´s even more. More powerful Intel Core 2 Duo processors. And more memory standard. Combine this with Mac OS X Leopard and iLife ´08, and it´s more all-in-one than ever. iMac packs amazing performance into a stunningly slim space.&lt;/div&gt;\r\n', '', 'Thùng loa Community', '', '');
INSERT INTO `oc_product_description` VALUES ('33', '2', 'Samsung SyncMaster 941BW', '&lt;div&gt;\r\n	Imagine the advantages of going big without slowing down. The big 19&amp;quot; 941BW monitor combines wide aspect ratio with fast pixel response time, for bigger images, more room to work and crisp motion. In addition, the exclusive MagicBright 2, MagicColor and MagicTune technologies help deliver the ideal image in every situation, while sleek, narrow bezels and adjustable stands deliver style just the way you want it. With the Samsung 941BW widescreen analog/digital LCD monitor, it&amp;#39;s not hard to imagine.&lt;/div&gt;\r\n', '', '', '', '');
INSERT INTO `oc_product_description` VALUES ('34', '2', 'Thung sup ', '&lt;div&gt;\r\n	&lt;strong&gt;Born to be worn.&lt;/strong&gt;\r\n	&lt;p&gt;\r\n		Clip on the worlds most wearable music player and take up to 240 songs with you anywhere. Choose from five colors including four new hues to make your musical fashion statement.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;strong&gt;Random meets rhythm.&lt;/strong&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		With iTunes autofill, iPod shuffle can deliver a new musical experience every time you sync. For more randomness, you can shuffle songs during playback with the slide of a switch.&lt;/p&gt;\r\n	&lt;strong&gt;Everything is easy.&lt;/strong&gt;\r\n	&lt;p&gt;\r\n		Charge and sync with the included USB dock. Operate the iPod shuffle controls with one hand. Enjoy up to 12 hours straight of skip-free music playback.&lt;/p&gt;\r\n&lt;/div&gt;\r\n', '', 'Thung sup ', '', '');
INSERT INTO `oc_product_description` VALUES ('43', '2', 'Thùng Martin F15 Và F 215 Thùng Martin F15 Và F 215', '&lt;div&gt;\r\n	&lt;p&gt;\r\n		&lt;b&gt;Intel Core 2 Duo processor&lt;/b&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Powered by an Intel Core 2 Duo processor at speeds up to 2.16GHz, the new MacBook is the fastest ever.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;b&gt;1GB memory, larger hard drives&lt;/b&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		The new MacBook now comes with 1GB of memory standard and larger hard drives for the entire line perfect for running more of your favorite applications and storing growing media collections.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;b&gt;Sleek, 1.08-inch-thin design&lt;/b&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		MacBook makes it easy to hit the road thanks to its tough polycarbonate case, built-in wireless technologies, and innovative MagSafe Power Adapter that releases automatically if someone accidentally trips on the cord.&lt;/p&gt;\r\n	&lt;p&gt;\r\n		&lt;b&gt;Built-in iSight camera&lt;/b&gt;&lt;/p&gt;\r\n	&lt;p&gt;\r\n		Right out of the box, you can have a video chat with friends or family,2 record a video at your desk, or take fun pictures with Photo Booth&lt;/p&gt;\r\n&lt;/div&gt;\r\n', '', 'Thùng Martin F15 Và F 215 Thùng Martin F15 Và F 215', '', '');
...
-- ----------------------------
INSERT INTO `oc_product_image` VALUES ('2360', '30', 'catalog/demo/canon_eos_5d_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2358', '47', 'catalog/demo/hp_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2362', '28', 'catalog/demo/htc_touch_hd_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2364', '41', 'catalog/demo/imac_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2369', '40', 'catalog/demo/iphone_4.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2376', '36', 'catalog/demo/ipod_nano_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2375', '36', 'catalog/demo/ipod_nano_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2380', '34', 'catalog/demo/ipod_shuffle_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2379', '34', 'catalog/demo/ipod_shuffle_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2386', '32', 'catalog/demo/ipod_touch_4.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2385', '32', 'catalog/demo/ipod_touch_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2384', '32', 'catalog/demo/ipod_touch_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2390', '43', 'catalog/demo/macbook_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2389', '43', 'catalog/demo/macbook_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2393', '44', 'catalog/demo/macbook_air_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2392', '44', 'catalog/demo/macbook_air_2.jpg', '0');
...
INSERT INTO `oc_product_image` VALUES ('2372', '48', 'catalog/demo/ipod_classic_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2371', '48', 'catalog/demo/ipod_classic_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2368', '40', 'catalog/demo/iphone_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2367', '40', 'catalog/demo/iphone_5.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2359', '30', 'catalog/demo/canon_eos_5d_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2357', '47', 'catalog/demo/hp_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2361', '28', 'catalog/demo/htc_touch_hd_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2363', '41', 'catalog/demo/imac_3.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2366', '40', 'catalog/demo/iphone_2.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2365', '40', 'catalog/demo/iphone_6.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2370', '48', 'catalog/demo/ipod_classic_4.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2374', '36', 'catalog/demo/ipod_nano_4.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2373', '36', 'catalog/demo/ipod_nano_5.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2378', '34', 'catalog/demo/ipod_shuffle_4.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2377', '34', 'catalog/demo/ipod_shuffle_5.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2383', '32', 'catalog/demo/ipod_touch_5.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2382', '32', 'catalog/demo/ipod_touch_6.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2381', '32', 'catalog/demo/ipod_touch_7.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2388', '43', 'catalog/demo/macbook_4.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2387', '43', 'catalog/demo/macbook_5.jpg', '0');
INSERT INTO `oc_product_image` VALUES ('2391', '44', 'catalog/demo/macbook_air_4.jpg', '0');
...
INSERT INTO `oc_product_reward` VALUES ('549', '28', '1', '400');
INSERT INTO `oc_product_reward` VALUES ('550', '43', '1', '600');
INSERT INTO `oc_product_reward` VALUES ('339', '29', '1', '0');
INSERT INTO `oc_product_reward` VALUES ('548', '30', '1', '200');
...
INSERT INTO `oc_product_special` VALUES ('442', '30', '1', '2', '90.0000', '0000-00-00', '0000-00-00');
INSERT INTO `oc_product_special` VALUES ('441', '30', '1', '1', '80.0000', '0000-00-00', '0000-00-00');
...
INSERT INTO `oc_setting` VALUES ('861', '0', 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', '0');
...
INSERT INTO `oc_setting` VALUES ('851', '0', 'config', 'config_maintenance', '0', '0');
INSERT INTO `oc_setting` VALUES ('852', '0', 'config', 'config_seo_url', '0', '0');
INSERT INTO `oc_setting` VALUES ('853', '0', 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', '0');
INSERT INTO `oc_setting` VALUES ('860', '0', 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', '0');
INSERT INTO `oc_setting` VALUES ('859', '0', 'config', 'config_file_max_size', '300000', '0');
INSERT INTO `oc_setting` VALUES ('854', '0', 'config', 'config_compression', '0', '0');
INSERT INTO `oc_setting` VALUES ('855', '0', 'config', 'config_secure', '0', '0');
INSERT INTO `oc_setting` VALUES ('856', '0', 'config', 'config_password', '1', '0');
INSERT INTO `oc_setting` VALUES ('857', '0', 'config', 'config_shared', '0', '0');
INSERT INTO `oc_setting` VALUES ('858', '0', 'config', 'config_encryption', '', '0');
INSERT INTO `oc_setting` VALUES ('850', '0', 'config', 'config_mail_alert', '', '0');
INSERT INTO `oc_setting` VALUES ('849', '0', 'config', 'config_mail_smtp_timeout', '5', '0');
INSERT INTO `oc_setting` VALUES ('847', '0', 'config', 'config_mail_smtp_password', '', '0');
INSERT INTO `oc_setting` VALUES ('848', '0', 'config', 'config_mail_smtp_port', '25', '0');
INSERT INTO `oc_setting` VALUES ('846', '0', 'config', 'config_mail_smtp_username', '', '0');
INSERT INTO `oc_setting` VALUES ('845', '0', 'config', 'config_mail_smtp_hostname', '', '0');
INSERT INTO `oc_setting` VALUES ('844', '0', 'config', 'config_mail_parameter', '', '0');
INSERT INTO `oc_setting` VALUES ('843', '0', 'config', 'config_mail_protocol', 'mail', '0');
INSERT INTO `oc_setting` VALUES ('842', '0', 'config', 'config_ftp_status', '0', '0');
INSERT INTO `oc_setting` VALUES ('841', '0', 'config', 'config_ftp_root', '', '0');
INSERT INTO `oc_setting` VALUES ('839', '0', 'config', 'config_ftp_username', '', '0');
INSERT INTO `oc_setting` VALUES ('840', '0', 'config', 'config_ftp_password', '', '0');
INSERT INTO `oc_setting` VALUES ('838', '0', 'config', 'config_ftp_port', '21', '0');
INSERT INTO `oc_setting` VALUES ('837', '0', 'config', 'config_ftp_hostname', 'atv1511.developer', '0');
INSERT INTO `oc_setting` VALUES ('836', '0', 'config', 'config_image_location_height', '50', '0');
INSERT INTO `oc_setting` VALUES ('835', '0', 'config', 'config_image_location_width', '268', '0');
INSERT INTO `oc_setting` VALUES ('834', '0', 'config', 'config_image_cart_height', '47', '0');
INSERT INTO `oc_setting` VALUES ('833', '0', 'config', 'config_image_cart_width', '47', '0');
INSERT INTO `oc_setting` VALUES ('832', '0', 'config', 'config_image_wishlist_height', '47', '0');
INSERT INTO `oc_setting` VALUES ('831', '0', 'config', 'config_image_wishlist_width', '47', '0');
INSERT INTO `oc_setting` VALUES ('830', '0', 'config', 'config_image_compare_height', '90', '0');
INSERT INTO `oc_setting` VALUES ('829', '0', 'config', 'config_image_compare_width', '90', '0');
INSERT INTO `oc_setting` VALUES ('828', '0', 'config', 'config_image_related_height', '80', '0');
INSERT INTO `oc_setting` VALUES ('827', '0', 'config', 'config_image_related_width', '80', '0');
INSERT INTO `oc_setting` VALUES ('825', '0', 'config', 'config_image_additional_width', '74', '0');
INSERT INTO `oc_setting` VALUES ('826', '0', 'config', 'config_image_additional_height', '74', '0');
INSERT INTO `oc_setting` VALUES ('824', '0', 'config', 'config_image_product_height', '228', '0');
INSERT INTO `oc_setting` VALUES ('823', '0', 'config', 'config_image_product_width', '228', '0');
INSERT INTO `oc_setting` VALUES ('822', '0', 'config', 'config_image_popup_height', '500', '0');
INSERT INTO `oc_setting` VALUES ('821', '0', 'config', 'config_image_popup_width', '500', '0');
INSERT INTO `oc_setting` VALUES ('820', '0', 'config', 'config_image_thumb_height', '228', '0');
INSERT INTO `oc_setting` VALUES ('819', '0', 'config', 'config_image_thumb_width', '228', '0');
INSERT INTO `oc_setting` VALUES ('818', '0', 'config', 'config_image_category_height', '80', '0');
INSERT INTO `oc_setting` VALUES ('817', '0', 'config', 'config_image_category_width', '80', '0');
INSERT INTO `oc_setting` VALUES ('816', '0', 'config', 'config_icon', 'catalog/cart.png', '0');
INSERT INTO `oc_setting` VALUES ('815', '0', 'config', 'config_logo', 'catalog/loa/loa.jpg', '0');
INSERT INTO `oc_setting` VALUES ('813', '0', 'config', 'config_captcha', '', '0');
INSERT INTO `oc_setting` VALUES ('814', '0', 'config', 'config_captcha_page', '[\"review\",\"return\",\"contact\"]', '1');
INSERT INTO `oc_setting` VALUES ('812', '0', 'config', 'config_return_status_id', '2', '0');
INSERT INTO `oc_setting` VALUES ('810', '0', 'config', 'config_affiliate_mail', '0', '0');
INSERT INTO `oc_setting` VALUES ('811', '0', 'config', 'config_return_id', '0', '0');
INSERT INTO `oc_setting` VALUES ('809', '0', 'config', 'config_affiliate_id', '4', '0');
INSERT INTO `oc_setting` VALUES ('808', '0', 'config', 'config_affiliate_commission', '5', '0');
INSERT INTO `oc_setting` VALUES ('807', '0', 'config', 'config_affiliate_auto', '0', '0');
INSERT INTO `oc_setting` VALUES ('805', '0', 'config', 'config_stock_checkout', '0', '0');
INSERT INTO `oc_setting` VALUES ('806', '0', 'config', 'config_affiliate_approval', '0', '0');
INSERT INTO `oc_setting` VALUES ('804', '0', 'config', 'config_stock_warning', '0', '0');
INSERT INTO `oc_setting` VALUES ('802', '0', 'config', 'config_api_id', '1', '0');
INSERT INTO `oc_setting` VALUES ('803', '0', 'config', 'config_stock_display', '0', '0');
INSERT INTO `oc_setting` VALUES ('801', '0', 'config', 'config_order_mail', '0', '0');
INSERT INTO `oc_setting` VALUES ('800', '0', 'config', 'config_fraud_status_id', '7', '0');
INSERT INTO `oc_setting` VALUES ('799', '0', 'config', 'config_complete_status', '[\"5\",\"3\"]', '1');
INSERT INTO `oc_setting` VALUES ('798', '0', 'config', 'config_processing_status', '[\"5\",\"1\",\"2\",\"12\",\"3\"]', '1');
INSERT INTO `oc_setting` VALUES ('797', '0', 'config', 'config_order_status_id', '1', '0');
INSERT INTO `oc_setting` VALUES ('796', '0', 'config', 'config_checkout_id', '5', '0');
INSERT INTO `oc_setting` VALUES ('795', '0', 'config', 'config_checkout_guest', '1', '0');
INSERT INTO `oc_setting` VALUES ('794', '0', 'config', 'config_cart_weight', '1', '0');
INSERT INTO `oc_setting` VALUES ('793', '0', 'config', 'config_invoice_prefix', 'INV-2013-00', '0');
INSERT INTO `oc_setting` VALUES ('792', '0', 'config', 'config_account_mail', '0', '0');
INSERT INTO `oc_setting` VALUES ('791', '0', 'config', 'config_account_id', '3', '0');
INSERT INTO `oc_setting` VALUES ('790', '0', 'config', 'config_login_attempts', '5', '0');
INSERT INTO `oc_setting` VALUES ('789', '0', 'config', 'config_customer_price', '0', '0');
INSERT INTO `oc_setting` VALUES ('788', '0', 'config', 'config_customer_group_display', '[\"1\"]', '1');
INSERT INTO `oc_setting` VALUES ('787', '0', 'config', 'config_customer_group_id', '1', '0');
INSERT INTO `oc_setting` VALUES ('786', '0', 'config', 'config_customer_online', '0', '0');
INSERT INTO `oc_setting` VALUES ('785', '0', 'config', 'config_tax_customer', 'shipping', '0');
INSERT INTO `oc_setting` VALUES ('766', '0', 'config', 'config_country_id', '230', '0');
INSERT INTO `oc_setting` VALUES ('767', '0', 'config', 'config_zone_id', '3776', '0');
INSERT INTO `oc_setting` VALUES ('768', '0', 'config', 'config_language', 'vi', '0');
INSERT INTO `oc_setting` VALUES ('769', '0', 'config', 'config_admin_language', 'vi', '0');
INSERT INTO `oc_setting` VALUES ('770', '0', 'config', 'config_currency', 'USD', '0');
INSERT INTO `oc_setting` VALUES ('771', '0', 'config', 'config_currency_auto', '1', '0');
INSERT INTO `oc_setting` VALUES ('772', '0', 'config', 'config_length_class_id', '1', '0');
INSERT INTO `oc_setting` VALUES ('773', '0', 'config', 'config_weight_class_id', '1', '0');
INSERT INTO `oc_setting` VALUES ('774', '0', 'config', 'config_product_count', '1', '0');
INSERT INTO `oc_setting` VALUES ('775', '0', 'config', 'config_product_limit', '15', '0');
INSERT INTO `oc_setting` VALUES ('776', '0', 'config', 'config_product_description_length', '100', '0');
INSERT INTO `oc_setting` VALUES ('777', '0', 'config', 'config_limit_admin', '20', '0');
INSERT INTO `oc_setting` VALUES ('778', '0', 'config', 'config_review_status', '1', '0');
INSERT INTO `oc_setting` VALUES ('779', '0', 'config', 'config_review_guest', '1', '0');
INSERT INTO `oc_setting` VALUES ('780', '0', 'config', 'config_review_mail', '0', '0');
INSERT INTO `oc_setting` VALUES ('781', '0', 'config', 'config_voucher_min', '1', '0');
INSERT INTO `oc_setting` VALUES ('782', '0', 'config', 'config_voucher_max', '1000', '0');
INSERT INTO `oc_setting` VALUES ('783', '0', 'config', 'config_tax', '1', '0');
INSERT INTO `oc_setting` VALUES ('784', '0', 'config', 'config_tax_default', 'shipping', '0');
INSERT INTO `oc_setting` VALUES ('765', '0', 'config', 'config_comment', '', '0');
INSERT INTO `oc_setting` VALUES ('762', '0', 'config', 'config_fax', '', '0');
INSERT INTO `oc_setting` VALUES ('763', '0', 'config', 'config_image', 'catalog/loa/loa.jpg', '0');
INSERT INTO `oc_setting` VALUES ('764', '0', 'config', 'config_open', '', '0');
INSERT INTO `oc_setting` VALUES ('753', '0', 'config', 'config_meta_keyword', 'Thùng loa Hà Nội', '0');
INSERT INTO `oc_setting` VALUES ('754', '0', 'config', 'config_template', 'atv1511', '0');
INSERT INTO `oc_setting` VALUES ('755', '0', 'config', 'config_layout_id', '4', '0');
INSERT INTO `oc_setting` VALUES ('756', '0', 'config', 'config_name', 'Thùng loa Hà Nội', '0');
INSERT INTO `oc_setting` VALUES ('757', '0', 'config', 'config_owner', 'Thùng loa Hà Nội', '0');
INSERT INTO `oc_setting` VALUES ('758', '0', 'config', 'config_address', 'Thùng loa Hà Nội', '0');
INSERT INTO `oc_setting` VALUES ('759', '0', 'config', 'config_geocode', '', '0');
INSERT INTO `oc_setting` VALUES ('760', '0', 'config', 'config_email', 'hoangdv1112@gmail.com', '0');
INSERT INTO `oc_setting` VALUES ('761', '0', 'config', 'config_telephone', '123456789', '0');
INSERT INTO `oc_setting` VALUES ('752', '0', 'config', 'config_meta_description', 'Thùng loa Hà Nội', '0');
INSERT INTO `oc_setting` VALUES ('751', '0', 'config', 'config_meta_title', 'Thùng loa Hà Nội', '0');
INSERT INTO `oc_setting` VALUES ('862', '0', 'config', 'config_error_display', '1', '0');
INSERT INTO `oc_setting` VALUES ('863', '0', 'config', 'config_error_log', '1', '0');
INSERT INTO `oc_setting` VALUES ('864', '0', 'config', 'config_error_filename', 'error.log', '0');
...
INSERT INTO `oc_url_alias` VALUES ('853', 'product_id=30', 'canon-eos-5d');
INSERT INTO `oc_url_alias` VALUES ('852', 'product_id=47', 'hp-lp3065');
INSERT INTO `oc_url_alias` VALUES ('854', 'product_id=28', 'htc-touch-hd');
INSERT INTO `oc_url_alias` VALUES ('861', 'product_id=43', 'macbook');
INSERT INTO `oc_url_alias` VALUES ('862', 'product_id=44', 'macbook-air');
...
INSERT INTO `oc_url_alias` VALUES ('863', 'product_id=35', 'product-8');
...
INSERT INTO `oc_url_alias` VALUES ('855', 'product_id=41', 'imac');
INSERT INTO `oc_url_alias` VALUES ('856', 'product_id=40', 'iphone');
INSERT INTO `oc_url_alias` VALUES ('858', 'product_id=36', 'ipod-nano');
INSERT INTO `oc_url_alias` VALUES ('859', 'product_id=34', 'ipod-shuffle');
INSERT INTO `oc_url_alias` VALUES ('860', 'product_id=32', 'ipod-touch');
...
-- Records of oc_user
-- ----------------------------
INSERT INTO `oc_user` VALUES ('1', '1', 'admin', '0688f1fbca07114e514ed1849e173255e285a49b', 'SeqHvss7S', 'John', 'Doe', 'hoangdv1112@gmail.com', '', '', '127.0.0.1', '1', '2015-11-28 09:46:01');
