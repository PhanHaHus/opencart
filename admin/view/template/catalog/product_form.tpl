      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
              <!-- class= hidden ẩn đi những tab ko cần thiết -->
            <li class="active"><a href="#tab-general" data-toggle="tab"><?php echo $tab_general; ?></a></li>
            <li><a href="#tab-data" data-toggle="tab"><?php echo $tab_data; ?></a></li>
            <li><a href="#tab-links" data-toggle="tab"><?php echo $tab_links; ?></a></li>
            <li><a href="#tab-attribute" data-toggle="tab" class="hidden"><?php echo $tab_attribute; ?></a></li>
            <li><a href="#tab-option" data-toggle="tab" class="hidden"><?php echo $tab_option; ?></a></li>
            <li><a href="#tab-recurring" data-toggle="tab" class="hidden"><?php echo $tab_recurring; ?></a></li>
            ...
            <li><a href="#tab-reward" data-toggle="tab" class="hidden"><?php echo $tab_reward; ?></a></li>
            <li><a href="#tab-design" data-toggle="tab" class="hidden"><?php echo $tab_design; ?></a></li>
          </ul>
