...
class ControllerModuleArticle extends Controller {
	...
	public function index() {   
		...
		$data['entry_auto_seo'] = $this->language->get('entry_auto_seo');
		$data['entry_in_menubar'] = $this->language->get('entry_in_menubar');
		...
		$data['entry_facebook_comment'] = $this->language->get('entry_facebook_comment');
		$data['entry_facebook_apikey'] = $this->language->get('entry_facebook_apikey');
		$data['entry_facebook_apisecret'] = $this->language->get('entry_facebook_apisecret');
		...
		$data['button_cancel'] = $this->language->get('button_cancel');
 		...
 		if (isset($this->error['article_related'])) {
			$data['error_article_related'] = $this->error['article_related'];
		} else {
			$data['error_article_related'] = '';
		}
		...
		if (isset($this->request->post['auto_seo'])) {
			$data['auto_seo'] = $this->request->post['auto_seo'];
		} else {
			$data['auto_seo'] = $this->config->get('auto_seo');
		}

		if (isset($this->request->post['menubar'])) {
			$data['menubar'] = $this->request->post['menubar'];
		} else {
			$data['menubar'] = $this->config->get('menubar');
		}

		if (isset($this->request->post['image_article_width'])) {
			$data['image_article_width'] = $this->request->post['image_article_width'];
		} else {
			$data['image_article_width'] = $this->config->get('image_article_width');
		}
		
		if (isset($this->request->post['image_article_height'])) {
			$data['image_article_height'] = $this->request->post['image_article_height'];
		} else {
			$data['image_article_height'] = $this->config->get('image_article_height');
		}

		if (isset($this->request->post['article_related_width'])) {
			$data['article_related_width'] = $this->request->post['article_related_width'];
		} else {
			$data['article_related_width'] = $this->config->get('article_related_width');
		}
		
		if (isset($this->request->post['article_related_height'])) {
			$data['article_related_height'] = $this->request->post['article_related_height'];
		} else {
			$data['article_related_height'] = $this->config->get('article_related_height');
		}
		...
		if (isset($this->request->post['facebook_comment'])) {
			$data['facebook_comment'] = $this->request->post['facebook_comment'];
		} else {
			$data['facebook_comment'] = $this->config->get('facebook_comment');
		}
