...
class ControllerModuleEarthball extends Controller {
	...
	public function index() {
		...
		$this->data['entry_auto_refresh'] = $this->language->get('entry_auto_refresh');
		$this->data['entry_dashboard_status'] = $this->language->get('entry_dashboard_status');
		$this->data['entry_dashboard_limit'] = $this->language->get('entry_dashboard_limit');
		$this->data['entry_earth_code'] = $this->language->get('entry_earth_code');
		$this->data['entry_show_globe'] = $this->language->get('entry_show_globe');
		$this->data['entry_show_visitors'] = $this->language->get('entry_show_visitors');
		$this->data['entry_show_bots'] = $this->language->get('entry_show_bots');
		$this->data['entry_expiry_time'] = $this->language->get('entry_expiry_time');
		...
		$this->data['button_whos_online'] = $this->language->get('button_whos_online');
		$this->data['button_reset_counter'] = $this->language->get('button_reset_counter');
		$this->data['button_add_module'] = $this->language->get('button_add_module');
		$this->data['button_remove'] = $this->language->get('button_remove');

		$this->data['reset_counter'] = $this->url->link('module/earthball/reset_counter', 'token=' . $this->session->data['token'], 'SSL');
 		...
 		if (isset($this->error['auto_refresh'])) {
			$this->data['error_auto_refresh'] = $this->error['auto_refresh'];
		} else {
			$this->data['error_auto_refresh'] = '';
		}

 		if (isset($this->error['expiry_time'])) {
			$this->data['error_expiry_time'] = $this->error['expiry_time'];
		} else {
			$this->data['error_expiry_time'] = '';
		}
		...
		$this->data['action'] = $this->url->link('module/earthball', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['whos_online'] = $this->url->link('module/earthball/whos_online', 'token=' . $this->session->data['token'], 'SSL');

		if (isset($this->request->post['earthball_dashboard_status'])) {
			$this->data['earthball_dashboard_status'] = $this->request->post['earthball_dashboard_status'];
		} else {
			$this->data['earthball_dashboard_status'] = $this->config->get('earthball_dashboard_status');
		}

		if (isset($this->request->post['earthball_dashboard_limit'])) {
			$this->data['earthball_dashboard_limit'] = $this->request->post['earthball_dashboard_limit'];
		} else {
			$this->data['earthball_dashboard_limit'] = $this->config->get('earthball_dashboard_limit');
		}

		if (isset($this->request->post['earthball_auto_refresh'])) {
			$this->data['earthball_auto_refresh'] = $this->request->post['earthball_auto_refresh'];
		} elseif ($this->config->get('earthball_auto_refresh')) {
			$this->data['earthball_auto_refresh'] = $this->config->get('earthball_auto_refresh');
		} else {
			$this->data['earthball_auto_refresh'] = 60;
		}

		if (isset($this->request->post['earthball_earth_code'])) {
			$this->data['earthball_earth_code'] = $this->request->post['earthball_earth_code'];
		} elseif ($this->config->get('earthball_earth_code')) {
			$this->data['earthball_earth_code'] = $this->config->get('earthball_earth_code');
		} else {
			$this->data['earthball_earth_code'] = $this->language->get('text_start_ball');
		}

		if (isset($this->request->post['earthball_show_globe'])) {
			$this->data['earthball_show_globe'] = $this->request->post['earthball_show_globe'];
		} else {
			$this->data['earthball_show_globe'] = $this->config->get('earthball_show_globe');
		}

		if (isset($this->request->post['earthball_show_visitors'])) {
			$this->data['earthball_show_visitors'] = $this->request->post['earthball_show_visitors'];
		} else {
			$this->data['earthball_show_visitors'] = $this->config->get('earthball_show_visitors');
		}

		if (isset($this->request->post['earthball_show_bots'])) {
			$this->data['earthball_show_bots'] = $this->request->post['earthball_show_bots'];
		} else {
			$this->data['earthball_show_bots'] = $this->config->get('earthball_show_bots');
		}

		if (isset($this->request->post['earthball_expiry_time'])) {
			$this->data['earthball_expiry_time'] = $this->request->post['earthball_expiry_time'];
		} else {
			$this->data['earthball_expiry_time'] = $this->config->get('earthball_expiry_time');
		}

		if (isset($this->request->post['earthball_show_module'])) {
			$this->data['earthball_show_module'] = $this->request->post['earthball_show_module'];
		} else {
			$this->data['earthball_show_module'] = $this->config->get('earthball_show_module');
		}
		...
		foreach ($modules as $module) {
			if (isset($this->request->post['earthball_' . $module . '_layout_id'])) {
				$this->data['earthball_' . $module . '_layout_id'] = $this->request->post['earthball_' . $module . '_layout_id'];
			} else {
				$this->data['earthball_' . $module . '_layout_id'] = $this->config->get('earthball_' . $module . '_layout_id');
			}	

			if (isset($this->request->post['earthball_' . $module . '_position'])) {
				$this->data['earthball_' . $module . '_position'] = $this->request->post['earthball_' . $module . '_position'];
			} else {
				$this->data['earthball_' . $module . '_position'] = $this->config->get('earthball_' . $module . '_position');
			}	

			if (isset($this->request->post['earthball_' . $module . '_status'])) {
				$this->data['earthball_' . $module . '_status'] = $this->request->post['earthball_' . $module . '_status'];
			} else {
				$this->data['earthball_' . $module . '_status'] = $this->config->get('earthball_' . $module . '_status');
			}	

			if (isset($this->request->post['earthball_' . $module . '_sort_order'])) {
				$this->data['earthball_' . $module . '_sort_order'] = $this->request->post['earthball_' . $module . '_sort_order'];
			} else {
				$this->data['earthball_' . $module . '_sort_order'] = $this->config->get('earthball_' . $module . '_sort_order');
			}				
		}
		...
		if (isset($this->request->post['earthball_module'])) {
			$this->data['earthball_module'] = $this->request->post['earthball_module'];
		} else {
			$this->data['earthball_module'] = $this->config->get('earthball_module');
		}
	...
	public function whos_online() {
		...
		$this->data['whois_lookup'] = 'http://whois.domaintools.com/';

		$this->data['heading_title'] = $this->language->get('heading_whos_online');

		$this->data['text_online'] = sprintf($this->language->get('text_online'), $total_online);
		$this->data['text_customers_online'] = sprintf($this->language->get('text_customers_online'), $total_customers_online);
		$this->data['text_guests_online'] = sprintf($this->language->get('text_guests_online'), $total_guests_online);
		$this->data['text_bots_online'] = sprintf($this->language->get('text_bots_online'), $total_bots_online);
		$this->data['text_duplicate'] = sprintf($this->language->get('text_duplicate'), $ip_duplicates);
		$this->data['text_unique'] = sprintf($this->language->get('text_unique'), ($total_online - $ip_duplicates));
		$this->data['text_expiry_time'] = sprintf($this->language->get('text_expiry_time'), ($this->config->get('earthball_expiry_time') / 60));
		$this->data['text_cart_empty'] = $this->language->get('text_cart_empty');
		...
		$this->data['column_shopping_cart'] = $this->language->get('column_shopping_cart');

		$this->data['button_refresh_list'] = $this->language->get('button_refresh_list');

		$this->data['refresh_list'] = $this->url->link('module/earthball/whos_online', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function counter_statistics() {
		...
		$this->data['heading_title'] = $this->language->get('heading_counter');
		$this->data['heading_overview'] = $this->language->get('heading_overview');
		$this->data['heading_statistics'] = $this->language->get('heading_statistics');
		$this->data['heading_charts'] = $this->language->get('heading_charts');
		$this->data['heading_visitors'] = $this->language->get('heading_visitors');
		$this->data['heading_customers'] = $this->language->get('heading_customers');

		$this->data['text_overview'] = $this->language->get('text_overview');
		$this->data['text_totals'] = $this->language->get('text_totals');
		$this->data['text_visitor_averages'] = $this->language->get('text_visitor_averages');
		$this->data['text_customer_averages'] = $this->language->get('text_customer_averages');
		$this->data['text_guest_averages'] = $this->language->get('text_guest_averages');
		$this->data['text_page_view_averages'] = $this->language->get('text_page_view_averages');
		$this->data['text_counter_start_date'] = $this->language->get('text_counter_start_date');
		$this->data['text_days_online'] = $this->language->get('text_days_online');
		$this->data['text_weeks_online'] = $this->language->get('text_weeks_online');
		$this->data['text_months_online'] = $this->language->get('text_months_online');
		$this->data['text_total_visitors'] = $this->language->get('text_total_visitors');
		$this->data['text_total_customers'] = $this->language->get('text_total_customers');
		$this->data['text_total_guests'] = $this->language->get('text_total_guests');
		$this->data['text_total_page_views'] = $this->language->get('text_total_page_views');
		$this->data['text_daily_visitors'] = $this->language->get('text_daily_visitors');
		$this->data['text_weekly_visitors'] = $this->language->get('text_weekly_visitors');
		$this->data['text_monthly_visitors'] = $this->language->get('text_monthly_visitors');
		$this->data['text_daily_customers'] = $this->language->get('text_daily_customers');
		$this->data['text_weekly_customers'] = $this->language->get('text_weekly_customers');
		$this->data['text_monthly_customers'] = $this->language->get('text_monthly_customers');
		$this->data['text_daily_guests'] = $this->language->get('text_daily_guests');
		$this->data['text_weekly_guests'] = $this->language->get('text_weekly_guests');
		$this->data['text_monthly_guests'] = $this->language->get('text_monthly_guests');
		$this->data['text_daily_page_views'] = $this->language->get('text_daily_page_views');
		$this->data['text_weekly_page_views'] = $this->language->get('text_weekly_page_views');
		$this->data['text_monthly_page_views'] = $this->language->get('text_monthly_page_views');
		...
		$this->data['counter_start_date'] = $counter_start_date;
		$this->data['days_online'] = number_format($days_online);
		$this->data['weeks_online'] = number_format($weeks_online);
		$this->data['months_online'] = number_format($months_online);
		$this->data['total_visitors'] = number_format($total_visitors);
		$this->data['total_customers'] = number_format($total_customers);
		$this->data['total_guests'] = number_format($total_guests);
		$this->data['total_page_views'] = number_format($total_page_views);
		$this->data['daily_visitors'] = number_format($daily_visitors);
		$this->data['weekly_visitors'] = number_format($weekly_visitors);
		$this->data['monthly_visitors'] = number_format($monthly_visitors);
		$this->data['daily_customers'] = number_format($daily_customers);
		$this->data['weekly_customers'] = number_format($weekly_customers);
		$this->data['monthly_customers'] = number_format($monthly_customers);
		$this->data['daily_guests'] = number_format($daily_guests);
		$this->data['weekly_guests'] = number_format($weekly_guests);
		$this->data['monthly_guests'] = number_format($monthly_guests);
		$this->data['daily_page_views'] = number_format($daily_page_views);
		$this->data['weekly_page_views'] = number_format($weekly_page_views);
		$this->data['monthly_page_views'] = number_format($monthly_page_views);
